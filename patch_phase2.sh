#!/bin/bash
# ============================================================
# Ad-Leak-Engine [SEED: 2399] — PHASE 2 SCHEMA PATCH
# ============================================================
set -e

echo ""
echo "=========================================================="
echo "  Ad-Leak-Engine [SEED: 2399] — PATCHING PAGE SCHEMA"
echo "=========================================================="
...
# ---------- 2. Update Page Schema to include `raw` dict ----------
...
# ---------- 3. Execute Tests ----------
echo "[SEED:2399] Schema patched. Re-running Phase 2 test suite..."
python -m pytest tests/unit/ -v --tb=short

echo ""
echo "=========================================================="
echo "  [SEED: 2399] PATCH COMPLETE"
echo "=========================================================="